...
//	if(yAxis>0){
//		ILI9341_DrawText("FORWARD", FONT3, 0	, 0, BLUE, WHITE);
//	}
//	else if(yAxis<0){
//			ILI9341_DrawText("BACKWARD", FONT3, 0	, 0, BLUE, WHITE);
//		}
//	if(state == AutoMove){
...
void speedLCD_ON(int16_t xAxis, int16_t yAxis, uint8_t state) {
	...
	ILI9341_DrawLine(160, 240, 160 - (95 * cos(pwmvalue * 3.14 / 180)),
			240 - 95 * sin(pwmvalue * 3.14 / 180), RED);
	HAL_Delay(15);
	ILI9341_DrawLine(160, 240, 160 - (95 * cos(pwmvalue * 3.14 / 180)),
			240 - 95 * sin(pwmvalue * 3.14 / 180), WHITE);
